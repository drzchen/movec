...
$Header: /mnt/leo2/cvs/sabo/hist-040105/wu-ftpd/f2/realpath-2.4.2.c,v 1.1.1.1 2004/01/05 17:27:49 tleek Exp $
...
char *my_realpath(const char *pathname, char *result, char* chroot_path){
  ...
  printf("strcpy(curpath, pathname):Copying %lu bytes into an array of size %lu\n", 
